                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6} lg={2}>
                        <TextField
                            ...
                            name="firstName"
                            label="First name"
                            value={newCallmapRecord.firstName}
                            fullWidth
                    ...
                    <Grid item xs={12} sm={6} lg={2}>
                        <TextField
                            ...
                            name="lastName"
                            label="Last name"
                            value={newCallmapRecord.lastName}
                            fullWidth
                            onChange={(event: any) => onTextFieldChange(event)}
                        />
                    </Grid>
                    <Grid item xs={12} sm={6} lg={2}>
                        ...
                        <Select
                            ...
                            id="priority"
                            name="priority"
                            value={newCallmapRecord.priority}
                ...
                <Grid container spacing={3} style={{ paddingTop: '8px' }}>
                    <Grid item xs={12} sm={6} lg={2}>
                        <TextField
                            ...
                            name="phoneNumber"
                            label="Phone number"
                            value={newCallmapRecord.phoneNumber}
                            fullWidth
                            onChange={(event: any) => onTextFieldChange(event)}
                        />
                    </Grid>
                ...
                <Grid container spacing={3} style={{ paddingTop: '24px' }}>
                    <Grid item xs={12} sm={6} lg={4}>
                        <TextField
                            ...
                            name="callNote"
                            label="Call Note"
                            value={newCallmapRecord.callNote}
                            fullWidth
                            onChange={(event: any) => onTextFieldChange(event)}
                        />
                    </Grid>
                ...
                <Grid container spacing={3} style={{ paddingTop: '32px' }}>
                    <Grid item xs={12} sm={6} lg={4}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Button variant="contained" color="primary" onClick={(event: any) => handleFormSubmit(event)}>Add Record</Button>
                            <Button variant="contained" color="secondary" onClick={(event: any) => handleFormCancel(event)}>Cancel Record</Button>
                        </div>
                    </Grid>
                </Grid>
            </Fragment>
